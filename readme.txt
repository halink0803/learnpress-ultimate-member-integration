...
Installing "LearnPress Ultimate Member Integration" can be done either by searching for "LearnPress Ultimate Member Integration" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
